...
* Disability is among the least-studied axes in AI fairness research [3]. Existing T2I bias literature focuses overwhelmingly on gender [4] and race [5]. Disability, when studied, is treated as a unidimensional variable evaluated on descriptive rather than professional prompts. We are not aware of prior work systematically examining how disability conditions, across mobility, vision, hearing, and mental health subtypes, interact with professional contexts to produce qualitatively distinct failure modes.
