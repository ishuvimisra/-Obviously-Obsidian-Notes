...
4. Paper doesn't exactly introduce mitigation techniques but sees the mitgation techniques that are used by the models that is SDXL and DALLE3 are helpful or not and compares each model accordingly.
Findings: 
