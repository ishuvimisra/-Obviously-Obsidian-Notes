...
1. First thing we do is take the entire species randomly,1 in the beginning of the genome means that the item should be included in the bag pack and 0 means otherwise.
...
<mark style="background: #ADCCFFA6;">This algorithm is not deterministic that means it gives a different solution each time around.
</mark>
